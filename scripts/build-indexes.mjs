...
<p class="muted small"><a href="/posts/">See full feed →</a></p>
  ...
  function themeHandlerScript(){
    return `<script>(function(){
      ...
      function crtIcon(){
        return '<svg class="theme-ico" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M5 4h14a2 2 0 0 1 2 2v10a3 3 0 0 1-3 3h-4l1.5 2H8.5L10 19H6a3 3 0 0 1-3-3V6a2 2 0 0 1 2-2Zm0 2v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6H5Z"/></svg>';
      }
