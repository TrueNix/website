    ...
    return `<script>(function(){
      ...
      function render(){
        if(isRetro()){
          ...
          btn.innerHTML = '<span class="theme-screen">' + flatIcon() + '</span><span class="theme-label">Modern</span>';
          btn.setAttribute('title','Switch to modern');
          btn.setAttribute('aria-label','Switch to modern');
        }else{
          btn.classList.remove('is-retro');
          btn.innerHTML = '<span class="theme-screen">' + crtIcon() + '</span><span class="theme-label">CRT</span>';
